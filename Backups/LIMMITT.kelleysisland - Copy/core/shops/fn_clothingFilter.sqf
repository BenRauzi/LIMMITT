...
_clothes = switch (life_clothing_store) do
{
	...
	case "lsmo": {[_selection] call life_fnc_clothing_lsmo;};
	case "trooper": {[_selection] call life_fnc_clothing_trooper;};
	case "command_cop": {[_selection] call life_fnc_clothing_command_cop;};
};
