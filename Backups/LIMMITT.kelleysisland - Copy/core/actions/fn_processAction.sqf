...
_itemInfo = switch (_type) do
{
	...
	case "meth": {["methu","methp",5000,"Mixing Meth"];};
	case "meth2": {["methp","meth2",5000,"Purifying Meth"];};
	...
	//**OTHER METALS ARE Not to be included in-game YET
	case "promethium": {["uranium","uraniumr",5000,"Refining Uranium"];};
	case "plutonium": {["uranium","uraniumr",5000,"Refining Uranium"];};
