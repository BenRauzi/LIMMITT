...
[[1,"There is already a gang created with that name please pick another name."],"life_fnc_broadcast",_ownerID,false] spawn bis_fnc_mp;
[["life_action_gangInUse",nil,missionNamespace],"life_fnc_netSetVar",_ownerID,false] spawn bis_fnc_mp;
};
...
if(count _queryResult != 0) exitWith {
[[1,"You are currently already active in a gang, please leave the gang first."],"life_fnc_broadcast",_ownerID,false] spawn bis_fnc_mp;
[["life_action_gangInUse",nil,missionNamespace],"life_fnc_netSetVar",_ownerID,false] spawn bis_fnc_mp;
};
...
[[_group],"life_fnc_gangCreated",_ownerID,false] spawn bis_fnc_mp;
