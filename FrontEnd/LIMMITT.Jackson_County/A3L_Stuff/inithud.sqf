...
while {true} do {
    ...
    _threatcolor = "#00FF4C";
    _threattext = parseText format["Threat Level Green"];
    _magcolor = "#FFFFFF";
    _ammocolor = "#FFFFFF";
...
switch (missionNameSpace getVariable ['GM_ThreatLevel',0]) do { 
    ...
    case 1: {
        _threatcolor = "#EAFF00";
         _threattext = parseText format["Threat Level Amber"];
    }; 
    case 2: {
        _threatcolor = "#590000";
         _threattext = parseText format["Threat Level Red"];
    }; 
    case 3: {
        _threatcolor = "#590000";
         _threattext = parseText format["Martial Law In Affect"];
    }; 
};

_playerstatustext = parseText format ["<t font='puristaLight' size='1' align='right'><t color='%9'>%10</t> | <t color='%1'>%2</t> | <t color='%3'>%4</t> | <t color='%5'>%6</t> | <t color='%7'>%8</t></t>", _healthcolor, _healthtext, _staminacolor, _staminatext, _hungercolor, _hungertext, _thirstcolor, _thirsttext, _threatcolor, _threattext];
_playernametext = parseText format ["<t font='puristaLight' color='#FFFFFF' size='1.3' align='right'>%1</t>", _nameofplayer];
//_zeroinghudtext = parseText format ["<t font='puristaLight' color='#949494' size='1' align='left'>%1</t>", _zeroingtext];
_ammohudtext = parseText format ["<t font='puristaLight' color='%1' size='0.9' align='left'>%2</t>",_ammocolor, _ammotext];
_maghudtext = parseText format ["<t font='puristaLight' color='%1' size='1' align='left'>%2</t>", _magcolor, _amountmagtext];
_gunmodetext = parseText format ["<t font='puristaLight' color='#FFFFFF' size='1' align='center'>%1</t>", _gunmode];
