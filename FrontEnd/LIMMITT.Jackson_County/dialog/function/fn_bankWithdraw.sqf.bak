...
if(_val > gm_memecash) exitWith {hint localize "STR_ATM_NotEnoughFunds"};
if(_val < 100 && gm_memecash > 20000000) exitWith {hint localize "STR_ATM_WithdrawMin"}; //Temp fix for something.
