...
if((_hideout getVariable ["inCapture",FALSE])) exitWith {["Error", localize "STR_GNOTF_Captured",  "Error"] call Harris_Notifications;};
...
[[[0,1],format[localize "STR_GNOTF_CaptureSuccess",name player,(group player) getVariable "gang_name" ]],"life_fnc_broadcast",true,false] spawn bis_fnc_mp;
