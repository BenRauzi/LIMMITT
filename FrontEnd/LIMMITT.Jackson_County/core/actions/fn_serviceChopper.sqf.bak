...
if(LIMMITTCASH < 1000) exitWith {hint localize "STR_Serive_Chopper_NotEnough"};
LIMMITTCASH = LIMMITTCASH - 1000;
...
{
	[[(_search select 0),1],"life_fnc_setFuel",(_search select 0),false] spawn bis_fnc_mp;
}
	else
{
