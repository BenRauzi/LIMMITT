...
if(gm_memecash < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-gm_memecash)] call life_fnc_numberText];};
