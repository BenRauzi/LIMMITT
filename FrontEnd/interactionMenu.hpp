class radialMenu 
{
	...
	{	
		// Defines
			class psi_radial_button: RscButton {
				idc = -1;
		...
		// Centre
			class radial_centre: psi_radial
			{
				idc = 1999;
				text = "\PsiSyn_Client\radial\radial_centre.paa";
			};

		// Inner 1 (Top Centre)
			class radial_centretop_i: psi_radial
			{
				idc = 1110;
				text = "\PsiSyn_Client\radial\radial_centretop_i.paa";
			};
			class Icon_1_i: RscPicture
			{
				idc = 1111;
				text = "\PsiSyn_Client\radial\icons\050-money.paa.paa";
			...
			class Button_1_i: psi_radial_button
			{
				idc = 1113;
				...
				w = 0.06 * safezoneW;
				h = 0.09 * safezoneH;
				action = "[0] call PSI_fnc_interactionExecute;";
			};
		// Outer 1 (Top Centre)
			class radial_outer_1: psi_radial
			{
				idc = 1210;
				text = "\PsiSyn_Client\radial\radial_centretop_o.paa";
			};
			...
			class Button_1_o_1: psi_radial_button
			{
				idc = 1219;
				...
				h = 0.055 * safezoneH;
				action = "[1,1] call PSI_fnc_interactionExecute;";
			};
			
			class Button_1_o_2: psi_radial_button
			{
				idc = 1220;
				...
				w = 0.0360937 * safezoneW;
				h = 0.055 * safezoneH;
				action = "[2,1] call PSI_fnc_interactionExecute;";
			};
			class Button_1_o_3: psi_radial_button
			{
				idc = 1221;
				...
				w = 0.0360937 * safezoneW;
				h = 0.055 * safezoneH;
				action = "[3,1] call PSI_fnc_interactionExecute;";
			};
			class Button_1_o_4: psi_radial_button
			{
				idc = 1222;
				...
				w = 0.0360937 * safezoneW;
				h = 0.055 * safezoneH;
				action = "[4,1] call PSI_fnc_interactionExecute;";
			};

		// Inner 2 (Top Right)

			class radial_topright_i: psi_radial
			{
				idc = 2110;
				text = "\PsiSyn_Client\radial\radial_topright_i.paa";
			};
			...
			class Button_2_i: psi_radial_button
			{
				idc = 2113;
				...
				w = 0.06 * safezoneW;
				h = 0.1 * safezoneH;
				action = "[1] call PSI_fnc_interactionExecute;";
			};
		// Outer 2 (Top Right)
			class radial_outer_2: psi_radial
			{
				idc = 2210;

				text = "\PsiSyn_Client\radial\radial_topright_o.paa";
			};
			...
			class Button_2_o_1: psi_radial_button
			{
				idc = 2219;
			...
			class Button_2_o_2: psi_radial_button
			{
				idc = 2220;
			...
			class Button_2_o_3: psi_radial_button
			{
				idc = 2221;
			...
			class Button_2_o_4: psi_radial_button
			{
				idc = 2222;
		...
		// Inner 3 (Centre Right)
			...
			class radial_centreright_i: psi_radial
			{
				idc = 3110;
				text = "\PsiSyn_Client\radial\radial_centreright_i.paa";
			};
			...
			class Button_3_i: psi_radial_button
			{
				idc = 3113;
				...
				w = 0.06 * safezoneW;
				h = 0.09 * safezoneH;
				action = "[2] call PSI_fnc_interactionExecute;";
			};
		// Outer 3 (Centre Right)
			class radial_outer_3: psi_radial
			{
				idc = 3210;

				text = "\PsiSyn_Client\radial\radial_centreright_o.paa";
			};
			...
			class Button_3_o_1: psi_radial_button
			{
				idc = 3219;
			...
			class Button_3_o_2: psi_radial_button
			{
				idc = 3220;
			...
			class Button_3_o_3: psi_radial_button
			{
				idc = 3221;
			...
			class Button_3_o_4: psi_radial_button
			{
				idc = 3222;
		...
		// Inner 4 (Bottom Right)
				...
				class radial_bottomright_i: psi_radial
				{
					idc = 4110;
					text = "\PsiSyn_Client\radial\radial_bottomright_i.paa";
				};
				...
				class Button_4_i: psi_radial_button
				{
					idc = 4113;
					x = 0.520625 * safezoneW + safezoneX;
					...
					w = 0.05 * safezoneW;
					h = 0.09 * safezoneH;
					action = "[3] call PSI_fnc_interactionExecute;";
				};
		// Outer 4 (Bottom Right)
			class radial_outer_4: psi_radial
			{
				idc = 4210;

				text = "\PsiSyn_Client\radial\radial_bottomright_o.paa";
			};
			...
			class Button_4_o_1: psi_radial_button
			{
				idc = 4219;
			...
			class Button_4_o_2: psi_radial_button
			{
				idc = 4220;
			...
			class Button_4_o_3: psi_radial_button
			{
				idc = 4221;
			...
			class Button_4_o_4: psi_radial_button
			{
				idc = 4222;
		...
		// Inner 5 (Bottom Centre)
			...
			class radial_centrebottom_i: psi_radial
			{
				idc = 5110;
				text = "\PsiSyn_Client\radial\radial_centrebottom_i.paa";
			};
			...
			class Button_5_i: psi_radial_button
			{
				idc = 5113;
				...
				w = 0.05 * safezoneW;
				h = 0.09 * safezoneH;
				action = "[4] call PSI_fnc_interactionExecute;";
			};
		// Outer 5 (Bottom Centre)
			class radial_centrebottom_o: psi_radial
			{
				idc = 5210;

				text = "\PsiSyn_Client\radial\radial_centrebottom_o.paa";
			};
			...
			class Button_5_o_1: psi_radial_button
			{
				idc = 5219;
			...
			class Button_5_o_2: psi_radial_button
			{
				idc = 5220;
			...
			class Button_5_o_3: psi_radial_button
			{
				idc = 5221;
			...
			class Button_5_o_4: psi_radial_button
			{
				idc = 5222;
		...
		// Inner 6 (Bottom Left)
			...
			class radial_bottomleft_i: psi_radial
			{
				idc = 6110;
				text = "\PsiSyn_Client\radial\radial_bottomleft_i.paa";
			};
			...
			class Button_6_i: psi_radial_button
			{
				idc = 6113;
				...
				w = 0.06 * safezoneW;
				h = 0.09 * safezoneH;
				action = "[5] call PSI_fnc_interactionExecute;";
			};
		// Outer 6 (Bottom Left)
			class radial_bottomleft_o: psi_radial
			{
				idc = 6210;

				text = "\PsiSyn_Client\radial\radial_bottomleft_o.paa";
			};
			...
			class Button_6_o_1: psi_radial_button
			{
				idc = 6219;
			...
			class Button_6_o_2: psi_radial_button
			{
				idc = 6220;
			...
			class Button_6_o_3: psi_radial_button
			{
				idc = 6221;
			...
			class Button_6_o_4: psi_radial_button
			{
				idc = 6222;
		...
		// Inner 7 (Centre Left)
			class radial_centreleft_i: psi_radial
			{
				idc = 7110;
				text = "\PsiSyn_Client\radial\radial_centreleft_i.paa";
			};
			...
			class Button_7_i: psi_radial_button
			{
				idc = 7113;
				...
				w = 0.06 * safezoneW;
				h = 0.09 * safezoneH;
				action = "[6] call PSI_fnc_interactionExecute;";
			};
		// Outer 7 (Centre Left)
			class radial_centreleft_o: psi_radial
			{
				idc = 7210;

				text = "\PsiSyn_Client\radial\radial_centreleft_o.paa";
			};
			...
			class Button_7_o_1: psi_radial_button
			{
				idc = 7219;
			...
			class Button_7_o_2: psi_radial_button
			{
				idc = 7220;
			...
			class Button_7_o_3: psi_radial_button
			{
				idc = 7221;
				x = 0.365937 * safezoneW + safezoneX;
			...
			class Button_7_o_4: psi_radial_button
			{
				idc = 7222;
				x = 0.37625 * safezoneW + safezoneX;
		...
		// Inner 8 (Top Left)
			...
			class radial_topleft_i: psi_radial
			{
				idc = 8110;
				text = "\PsiSyn_Client\radial\radial_topleft_i.paa";
			};
			...
			class Button_8_i: psi_radial_button
			{
				idc = 8113;
				x = 0.412344 * safezoneW + safezoneX;
				y = 0.368 * safezoneH + safezoneY;
				w = 0.06 * safezoneW;
				h = 0.09 * safezoneH;
				action = "[7] call PSI_fnc_interactionExecute;";
			};
		// Outer 8 (Top Left)
			class radial_topleft_o: psi_radial
			{
				idc = 8210;

				text = "\PsiSyn_Client\radial\radial_topleft_o.paa";
			};
			...
			class Button_8_o_1: psi_radial_button
			{
				idc = 8219;
			...
			class Button_8_o_2: psi_radial_button
			{
				idc = 8220;
			...
			class Button_8_o_3: psi_radial_button
			{
				idc = 8221;
			...
			class Button_8_o_4: psi_radial_button
			{
				idc = 8222;
