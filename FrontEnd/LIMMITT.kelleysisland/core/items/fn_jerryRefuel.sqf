...
switch (true) do
{
	case (_vehicle isKindOF "LandVehicle"):
	{
		...
		{
			[[_vehicle,(Fuel _vehicle) + 0.5],"life_fnc_setFuel",_vehicle,false] spawn bis_fnc_mp;
		}
			else
		{
	...
	case (_vehicle isKindOf "Air"):
	{
		if(!local _vehicle) then
		{
			[[_vehicle,(Fuel _vehicle) + 0.2],"life_fnc_setFuel",_vehicle,false] spawn bis_fnc_mp;
		}
			else
		{
	...
	case (_vehicle isKindOf "Ship"):
	{
		if(!local _vehicle) then
		{
			[[_vehicle,(Fuel _vehicle) + 0.35],"life_fnc_setFuel",_vehicle,false] spawn bis_fnc_mp;
		}
			else
		{
