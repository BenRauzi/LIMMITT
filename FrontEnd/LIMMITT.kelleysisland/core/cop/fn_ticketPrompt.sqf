...
[] spawn
{
	...
	{
		[[0,format[localize "STR_Cop_Ticket_Refuse",profileName]],"life_fnc_broadcast",west,false] spawn bis_fnc_mp;
		[[1,format[localize "STR_Cop_Ticket_Refuse",profileName]],"life_fnc_broadcast",life_ticket_cop,false] spawn bis_fnc_mp;
	};
};