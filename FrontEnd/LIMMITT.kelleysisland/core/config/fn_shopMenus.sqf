...
ctrlSetText[601,format["Cash: $%1",[LIMMITTCASH] call life_fnc_numberText]];

switch (_shop) do
{
	case "reb":
	{
		ctrlSetText[2505,"DC Rebel Shop"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "cop":
	{
		ctrlSetText[2505,"DC Cop Shop"];
		ctrlShow[2503,false];
	};
	
	case "gun":
	{
		ctrlSetText[2505,"DC Gun Store"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "dive":
	{
		ctrlSetText[2505,"DC Diving Shop"];
		ctrlShow[2503,false];
		ctrlShow[2510,false];
		ctrlShow[2511,false];
		ctrlShow[2513,false];
	...
	case "gen":
	{
		ctrlSetText[2505,"DC General Store"];
		ctrlShow[2503,false];
	};
