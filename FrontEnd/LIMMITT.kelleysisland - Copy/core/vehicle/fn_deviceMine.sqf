...
[_vehicle,"life_fnc_soundDevice",true,false] spawn bis_fnc_mp; //Broadcast the 'mining' sound of the device for nearby units.
...
while {true} do {
	...
	if(local _vehicle) then {
		...
		[[_vehicle,(fuel _vehicle)-0.04],"life_fnc_setFuel",_vehicle,false] spawn bis_fnc_mp;
	};
