...
private["_containers"];
_containers = nearestObjects[getPosATL _corpse,["WeaponHolderSimulated"],7]; //Fetch list of containers (Simulated = weapons)
...
[[_unit,life_sidechat,playerSide],"TON_fnc_managesc",false,false] spawn bis_fnc_mp;
