...
if(typeName _queryResult == "STRING") exitWith {[[],"SOCK_fnc_dataQuery",(owner _returnToSender),false] spawn bis_fnc_mp;}; 
if(count _queryResult != 0) exitWith {[[],"SOCK_fnc_dataQuery",(owner _returnToSender),false] spawn bis_fnc_mp;};
...
_query = format["INSERT INTO players (playerid, name, cash, bankacc, aliases, cop_licenses, med_licenses, civ_licenses, civ_gear, cop_gear, med_gear, arrestreason, nametagcustomarray) VALUES('%1', '%2', '%3', '%4', '%5','""[]""','""[]""','""[]""','""[]""','""[]""','""[]""','%6','%7')",
_uid,
_name,
_money,
_bank,
...
[[],"SOCK_fnc_dataQuery",(owner _returnToSender),false] spawn bis_fnc_mp;