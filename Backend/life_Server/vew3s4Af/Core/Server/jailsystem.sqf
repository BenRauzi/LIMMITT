...
[[_personyouwanjail,_randomiets,_timeinminute,_reasonofjail],"fnc_sendtojail",_personyouwanjail,false] spawn bis_fnc_mp;
};
...
[[_ret,_bad],"fnc_jailsetup",_id,false] spawn bis_fnc_mp;
};
