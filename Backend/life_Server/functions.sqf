...
compileFinal "
	...
	[[gm_memecash,life_cash,owner player,player],""life_fnc_admininfo"",_ret,false] spawn bis_fnc_mp;
";
...
private[""_msg"",""_to""];
	...
	[[_msg,name player,5],""clientMessage"",independent,false] spawn bis_fnc_mp;
...
compileFinal "
	...
	[[_msg,name player,4],""clientMessage"",true,false] spawn bis_fnc_mp;
	[] call life_fnc_cellphone;
